...
class HospitalList: UITableViewController , NetworkCaller {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // #wrning Incomplete implementation, return the number of rows
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
     //   let cell = tableView.dequeueReusableCellWithIdentifier("reuseIdentifier", forIndexPath: indexPath)
        ...
        let curHospital = allHospitals[indexPath.row]
        cell.textLabel?.text = curHospital.hospitalName
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
     ...
     var nextScreen: HospotalListVC = self.storyboard?.instantiateViewControllerWithIdentifier("HspitalList") as! HospotalListVC
        
    //   nextScreen = allHospitals[indexPath.row]
